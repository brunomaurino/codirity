...
export function Section({
 ...
 // data-ground: consumed by TheConstant's tone-flip IO (W1). Only`ink`// is a dark ground;`gradient`is a light green TINT over the page (so it
 ...
 padding ==="hero"&&"min-h-screen py-24 md:py-32 lg:py-40 px-4 md:px-8 lg:px-16",
 // Background variants
 ...
 variant ==="gradient"&& ["bg-[linear-gradient(180deg,_rgba(50,_205,_50,_0.06)_0%,_rgba(89,_243,_89,_0.1)_50%,_rgba(50,_205,_50,_0.06)_100%)]","",
 ],
 className
 )}
 >
