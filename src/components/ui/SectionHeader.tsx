...
const SectionHeader =forwardRef<HTMLDivElement, SectionHeaderProps>(
 ...
 {label && (
 <span
 className={cn("inline-block font-sans text-[13px] font-medium uppercase tracking-[0.12em] mb-4",
 ...
 <h2
 className={cn("text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight",
 ...
 {description && (
 <p
 className={cn("mt-4 text-lg leading-relaxed",
 tone ==="ink"?"text-gray-300":"text-gray-600")}
 >
 {description}
 </p>
 )}
